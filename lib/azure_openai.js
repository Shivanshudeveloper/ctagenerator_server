...
async function azureBotResponsePredictScore(totalreach, pageClicks, pageViews, engagement) {
    ...
    const question = `Based on the above data you now need to tell whether the marketing campaign performance is "Good" or "Not Performing Good" overall. YOU NEED TO KEEP THE ANSWER IN LENGTH 100.`
...
module.exports = {azureBotResponse, azureBotResponseForMedical, azureBotResponsePredictScore};
